...
var show_user = function () {
    ...
    var taikhoan = document.querySelector(".taikhoan-1 span");
    ...
    listHistory.forEach(function (order, index) {
        if (
            ...
            newRow.innerHTML = `
                                    ...
                                    <td class="accountId">MADH0${i}</td>
                                    <td>${
                                        JSON.parse(order.Ordered.hang).TenSP
                                    }</td>
                                    <td><img src="${
                                        JSON.parse(order.Ordered.hang).img[0]
                                    }" alt="img" style="width:100%; max-width:150px;"></td>
                                    <td>${formatNumberWithCommas(
                                        GiamGia(
                                            JSON.parse(order.Ordered.hang).Gia,
                                            JSON.parse(order.Ordered.hang)
                                                .Coupon
                                        )
                                    )}</td>
