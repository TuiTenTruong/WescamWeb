...
function showsearch() {
    ...
    for (var i = 0; i < list_products_lap.length; i++) {
        if (
            list_products_lap[i].Brand.toLowerCase().includes(kw.toLowerCase())
        ) {
            type = "laptop";
